...
class App extends React.Component {
    ...
    loadData() {
        ...
        axios
            .get('http://151.248.125.11:8000/api/users/', {headers})
            .then(response => {
                this.setState({
        ...
        axios
            .get('http://151.248.125.11:8000/api/projects/', {headers})
            .then(response => {
                this.setState({
        ...
        axios
            .get('http://151.248.125.11:8000/api/todos/', {headers})
            .then(response => {
                this.setState({
    ...
    deleteProject(id) {
        const headers = this.getHeaders()
        axios.delete(`http://151.248.125.11:8000/api/projects/${id}/`, {headers})
            .then(response => {
                this.setState({
    ...
    deleteTodo(id) {
        const headers = this.getHeaders()
        axios.delete(`http://151.248.125.11:8000/api/todos/${id}/`, {headers})
            .then(response => {
    ...
    createProject(name, repo, users) {
        ...
        axios.post(`http://151.248.125.11:8000/api/projects/`, data, {headers})
            .then(response => {
    ...
    editProject(id, name, repo, users) {
        const headers = this.getHeaders()
        const data = {name: name, repoUrl: repo, users: users}
        axios.put(`http://151.248.125.11:8000/api/projects/${id}/`, data, {headers})
            .then(response => {
                let newProject = response.data;
                this.setState({projects: [...this.state.projects, newProject]})
            })
